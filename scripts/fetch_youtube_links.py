...
import yt_dlp
from concurrent.futures import ThreadPoolExecutor, wait, FIRST_COMPLETED  # ✅ fixed import
...
MAX_THREADS = 3  # ✅ three yt-dlp searches in parallel
    ...
    with ThreadPoolExecutor(max_workers=MAX_THREADS) as executor:
        ...
        for album in metadata:
            ...
            for track in tracks:
                ...
                # Small throttle to avoid bans
                time.sleep(DELAY_BETWEEN_SEARCHES + random.uniform(0.2, 0.8))

                # Wait for any to finish if max threads active
